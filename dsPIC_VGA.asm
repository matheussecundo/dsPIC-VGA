...
;dsPIC_VGA.c,332 :: 		snakeInit();
	CALL	_snakeInit
;dsPIC_VGA.c,333 :: 		return;
	GOTO	L_end_SNAKE_NullDraw_less_2_final_cycle
;dsPIC_VGA.c,335 :: 		}
L_SNAKE_NullDraw_less_2_final_cycle36:
;dsPIC_VGA.c,339 :: 		if (*snake.ipos == 7) {
	MOV	_snake, W0
	MOV.B	[W0], W0
	CP.B	W0, #7
...
;dsPIC_VGA.c,341 :: 		snakeInit();
	CALL	_snakeInit
;dsPIC_VGA.c,342 :: 		return;
	GOTO	L_end_SNAKE_NullDraw_less_2_final_cycle
;dsPIC_VGA.c,344 :: 		}
L_SNAKE_NullDraw_less_2_final_cycle37:
;dsPIC_VGA.c,348 :: 		if (*snake.ipos == 0) {
	MOV	_snake, W0
	MOV.B	[W0], W0
	CP.B	W0, #0
...
;dsPIC_VGA.c,350 :: 		*snake.fpos = 0;
	MOV	_snake+6, W1
	CLR	W0
	MOV.B	W0, [W1]
;dsPIC_VGA.c,352 :: 		snake.fpos = snake.fpos + snake.fdiry * MATRIX_COLUMNS + snake.fdirx;
	MOV	#lo_addr(_snake+10), W0
	SE	[W0], W1
	MOV	#40, W0
	MUL.SS	W1, W0, W2
...
;dsPIC_VGA.c,364 :: 		*snake.ipos = (snake.idir << 4) | 1;
	MOV	#lo_addr(_snake+2), W0
	SE	[W0], W0
	SL	W0, #4, W0
	IOR	W0, #1, W1
...
;dsPIC_VGA.c,370 :: 		int index = rand() % (MATRIX_SIZE - 200);
	CALL	_rand
	MOV	#1000, W2
	REPEAT	#17
	DIV.S	W0, W2
...
;dsPIC_VGA.c,371 :: 		while (matrix[index] != 0)
...
; index end address is: 4 (W2)
;dsPIC_VGA.c,373 :: 		index = rand() % (MATRIX_SIZE - 200);
	CALL	_rand
	MOV	#1000, W2
	REPEAT	#17
	DIV.S	W0, W2
...
;dsPIC_VGA.c,375 :: 		snake.apple_pos = &matrix[index];
	MOV	#lo_addr(_matrix), W0
	ADD	W0, W2, W1
; index end address is: 4 (W2)
	MOV	W1, _snake+12
;dsPIC_VGA.c,376 :: 		*snake.apple_pos = 5;
	MOV.B	#5, W0
	MOV.B	W0, [W1]
;dsPIC_VGA.c,377 :: 		snake.apple_qtd++;
	MOV	_snake+14, W0
	INC	W0
	MOV	W0, _snake+14
;dsPIC_VGA.c,378 :: 		}
L_SNAKE_NullDraw_less_2_final_cycle41:
;dsPIC_VGA.c,379 :: 		REP(1, 4, 5, NOP)
	NOP
	NOP
	NOP
	NOP
...
;dsPIC_VGA.c,390 :: 		VGA_COLOR = 0; REP(0, 0, 3, NOP)
	CLR	LATD
	NOP
	NOP
	NOP
...
;dsPIC_VGA.c,393 :: 		int main()
;dsPIC_VGA.c,395 :: 		config();
	CALL	_config
;dsPIC_VGA.c,396 :: 		snakeInit();
	CALL	_snakeInit
;dsPIC_VGA.c,398 :: 		while(1) {
L_main45:
;dsPIC_VGA.c,400 :: 		vsync_on;
	BCLR.B	LATFbits, #1
;dsPIC_VGA.c,401 :: 		HSYNC_NOPS NullDraw0();
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_NullDraw0
;dsPIC_VGA.c,402 :: 		HSYNC_NOPS NullDraw1();
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_NullDraw1
;dsPIC_VGA.c,403 :: 		HSYNC_NOPS NullDraw2();
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_NullDraw2
;dsPIC_VGA.c,404 :: 		HSYNC_NOPS NullDraw3();
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_NullDraw3
;dsPIC_VGA.c,405 :: 		vsync_off;
	BSET.B	LATFbits, #1
;dsPIC_VGA.c,408 :: 		REP(0, 2, 3, HSYNC_NOPS NullDraw();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_NullDraw
	...
	BSET.B	LATFbits, #0
	CALL	_NullDraw
;dsPIC_VGA.c,411 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_0();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_0
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_0
;dsPIC_VGA.c,412 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_1();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_1
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_1
;dsPIC_VGA.c,413 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_2();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_2
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_2
;dsPIC_VGA.c,414 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_3();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_3
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_3
;dsPIC_VGA.c,415 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_4();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_4
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_4
;dsPIC_VGA.c,416 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_5();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_5
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_5
;dsPIC_VGA.c,417 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_6();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_6
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_6
;dsPIC_VGA.c,418 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_7();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_7
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_7
;dsPIC_VGA.c,419 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_8();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_8
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_8
;dsPIC_VGA.c,420 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_9();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_9
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_9
;dsPIC_VGA.c,421 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_10();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_10
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_10
;dsPIC_VGA.c,422 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_11();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_11
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_11
;dsPIC_VGA.c,423 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_12();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_12
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_12
;dsPIC_VGA.c,424 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_13();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_13
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_13
;dsPIC_VGA.c,425 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_14();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_14
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_14
;dsPIC_VGA.c,426 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_15();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_15
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_15
;dsPIC_VGA.c,427 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_16();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_16
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_16
;dsPIC_VGA.c,428 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_17();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_17
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_17
;dsPIC_VGA.c,429 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_18();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_18
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_18
;dsPIC_VGA.c,430 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_19();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_19
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_19
;dsPIC_VGA.c,431 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_20();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_20
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_20
;dsPIC_VGA.c,432 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_21();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_21
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_21
;dsPIC_VGA.c,433 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_22();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_22
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_22
;dsPIC_VGA.c,434 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_23();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_23
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_23
;dsPIC_VGA.c,435 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_24();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_24
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_24
;dsPIC_VGA.c,436 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_25();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_25
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_25
;dsPIC_VGA.c,437 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_26();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_26
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_26
;dsPIC_VGA.c,438 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_27();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_27
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_27
;dsPIC_VGA.c,439 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_28();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_28
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_28
;dsPIC_VGA.c,440 :: 		REP(0, 2, 0, HSYNC_NOPS Draw_29();)
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
	CALL	_Draw_29
	...
	BSET.B	LATFbits, #0
	CALL	_Draw_29
;dsPIC_VGA.c,444 :: 		HSYNC_NOPS SNAKE_NullDraw_less_2_final_cycle();
	BCLR.B	LATFbits, #0
	CALL	_HSync_nops
	BSET.B	LATFbits, #0
